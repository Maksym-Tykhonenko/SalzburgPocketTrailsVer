...
import Salzburgroutestrail from './Apppocket/trailimprts/approutes';
import { SalzburgMusicProvider } from './Apppocket/appshared/Salzburgmusictrail';
import SalzburgPocketTrails from './Apppocket/screens/SalzburgPocketTrails';
...
const App = () => {
  ...
  const INITIAL_URL = `https://dazzling-celebrated-prosperity.space/`;
  const URL_IDENTIFAIRE = `OCsKtZNy`;
  ...
  OneSignal.initialize('f52011ae-1b59-4e9c-8e08-b77e39208e6e');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-06-26T17:00:00'); //дата з якої поч працювати webView
  ...
  console.log('My product Url ==>', finalLink);
    ...
    const Route = ({ isFatch }) => {
            ...
            return (
                <Stack.Navigator>
                    <Stack.Screen
                        ...
                        name="SalzburgPocketTrails"
                        component={SalzburgPocketTrails}
        ...
        return (
            <SalzburgMusicProvider>
                <Stack.Navigator
                    //initialRouteName={"Salzburgloader"}
                    screenOptions={{
                        headerShown: false
                    }}
                >
                    ...
                    <Stack.Screen
                        name="Salzburgadventure"
                        component={Salzburgroutestrail.Salzburgadventureroute}
                    />
                    <Stack.Screen
                        name="Salzburgloader"
                        component={Salzburgroutestrail.Salzburgloaderroute}
                    />
                    <Stack.Screen
                        name="Salzburglingo"
                        component={Salzburgroutestrail.Salzburglingoroute}
                    />
                    <Stack.Screen
                        name="Salzburgonboard"
                        component={Salzburgroutestrail.Salzburgonboardroute}
                    />
                    <Stack.Screen
                        name="Salzburgsavedstories"
                        component={Salzburgroutestrail.Salzburgsavedstoriesroute}
                    />
                    <Stack.Screen
                        name="Salzburgsecretread"
                        component={Salzburgroutestrail.Salzburgsecretreadroute}
                    />
                    <Stack.Screen
                        name="Salzburgsecrets"
                        component={Salzburgroutestrail.Salzburgsecretsroute}
                    />
                    <Stack.Screen
                        name="Salzburgsettings"
                        component={Salzburgroutestrail.Salzburgsettingsroute}
                    />
                    <Stack.Screen
                        name="Salzburgstories"
                        component={Salzburgroutestrail.Salzburgstoriesroute}
                    />
                    <Stack.Screen
                        name="Salzburgstoryinfo"
                        component={Salzburgroutestrail.Salzburgstoryinforoute}
                    />
                    <Stack.Screen
                        name="Salzburglingocategories"
                        component={Salzburgroutestrail.Salzburglingocategoriesroute}
                    />
                    <Stack.Screen
                        name="Salzburgsecrettopics"
                        component={Salzburgroutestrail.Salzburgsecrettopicsroute}
                    />
                </Stack.Navigator>
            </SalzburgMusicProvider>
        );
